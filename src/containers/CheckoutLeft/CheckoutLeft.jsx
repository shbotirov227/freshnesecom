  ...
  return (
    <div className="checkoutPage-left">
      ...
      <div className="formInputs">
        <div>
          <label htmlFor="firstName" className="labelElement">First Name</label>
          <input type="text" id="firstName" placeholder="First Name" className="inputElement" />
        </div>
    
        <div>
          <label htmlFor="lastName" className="labelElement">Last Name</label>
          <input type="text" id="lastName" placeholder="Last Name" className="inputElement" />
        </div>
      </div>

      <div className="formInputs">
        <div>
          <label htmlFor="email" className="labelElement">Email address</label>
          <input type="email" name="email" id="email" placeholder="Email address" className="inputElement" />
        </div>

        <div>
          <label htmlFor="tel" className="labelElement">Phone number</label>
          <input type="tel" id="tel" name="tel" placeholder="Phone number" className="inputElement" />
        </div>
      </div>

      <div className="formInputs">
        <div>
          <label htmlFor="address" className="labelElement">
            Address
          </label>
          <input type="text" id="address" placeholder="Adress" className="inputElement" />
        </div>

        <div>
          <label htmlFor="city" className="labelElement">Town / City</label>
          <input type="text" id="city" placeholder="Town or city" className="inputElement" />
        </div>
      </div>

      <div className="formInputs">
        <div>
          <label htmlFor="country" className="labelElement">State / Country</label>
        ...
        <div>
          <label htmlFor="postalCode" className="labelElement">ZIP/Postal code</label>
          <input type="text" id="postalCode" placeholder="Postal code or ZIP" className="inputElement" />
        </div>
      </div>

      <div className="checkboxElement checkboxLast">
        <input type="checkbox" name="" id="checkbox" style={{ cursor: "pointer" }} />
        <label htmlFor="checkbox" className="checkboxLabel" style={{ cursor: "pointer" }}>Ship to a different address?</label>
      </div>
      ...
      <div className="fedEx">
        ...
        <div className="radioSection">
          <div className="radioElement mb-4">
            <div className="d-flex align-center">
              <input type="radio" name="dostavka" id="fedEx" className="me-3" />
              <label htmlFor="fedEx" className="fedEx-title" style={{ cursor: "pointer" }}>FedEx</label>
            </div>
          ...
          <div className="radioElement">
            <div className="d-flex align-center">
              ...
              <label htmlFor="dhl" className="fedEx-title" style={{ cursor: "pointer" }}>DHL</label>
            </div>
      ...
      <div className="CreditCards">
        ...
        <div className="mb-4 w-100">
          ...
          <input type="text" id="cardNumber" placeholder="Card number" style={{ width: '100%' }} className="inputElement"/>
        </div>

        <div className="expirationItems" style={{ display: 'flex', justifyContent: 'space-between' }}>
          <div className="me-4">
            <label htmlFor="cardHolder"className="labelElement"style={{ display: "block" }}>Card holder</label>
            <input type="text" id="cardHolder" placeholder="Card holder" className="inputElement"/>
          </div>

          <div className="expiration">
            <div className="me-4">
              <label htmlFor="cardDate" className="labelElement">Expiration date</label>
              <input type="datetime-local" id="cardDate" placeholder="DD/MM/YY" className="inputElement"/>
            </div>

            <div>
              <label htmlFor="cardCvc" className="labelElement">CVC</label>
      ...
      <div className="radioSection">
        <div className="radioElement mb-4">
          <div className="d-flex align-center">
            ...
            <label htmlFor="paypal" className="fedEx-title">PayPal</label>
          </div>
          <img src={PayPal} alt="" />
        </div>
        ...
        <div className="radioElement">
          <div className="d-flex align-center">
            ...
            <label htmlFor="bitcoin" className="fedEx-title">Bitcoin</label>
          </div>
          <img src={Bitcoin} alt="" />
        </div>
      </div>
      ...
      <div className="confirmation  mb-5">
        ...
        <div className="d-flex align-items-center justify-content-between mb-5 spanTitles">
          <span className="checkoutSpan w-75">
        ...
        <div className="checkboxElement check2 d-flex align-items-center">
          ...
          <label htmlFor="reciept1" className="checkboxLabel">
        ...
        <div className="checkboxElement d-flex align-items-center" style={{ cursor: "pointer" }}>
          ...
          <label htmlFor="reciept2" className="checkboxLabel">I agree with our
        ...
        <span className="checkboxLabel d-block mt-5">Copyright © 2020 Freshnesecom</span>
      </div>
    </div>
  );
};
